      ...
      <div style="display:flex; justify-content:flex-end ; margin-bottom:100px;">
            ...
            >
              ...
              <v-card style="border-radius:1em;">
                ...
                <div class="col" >
                  <h3 class="text-center" style="font-size:2.0em; margin-bottom:30px;"><span style="color:skyblue">카드 결제 버튼</span>을 살짝 눌러 파란색이 되면 <span style="color:darkorange;">결제하기</span>를 눌러주세요!</h3>  
                  <h3 class="text-center" style="font-size:2.0em;">쿠폰이 있으시다면 <span style="color:#6699cc;">쿠폰 사용 버튼</span>을 눌러 입력해주세요! </h3>
                </div>
